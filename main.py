...
class GestureApp(ctk.CTk):
    def __init__(self, window_title):
        ...
        self.grace_period = float(os.getenv("GESTURE_GRACE_PERIOD_SECONDS")) # 0.5s grace period to stop flickering
        ...
        # Open video source
        self.vid = cv2.VideoCapture(int(os.getenv("CAMERA_INDEX")))
    ...
    def check_6_7_gesture(self):
        ...
        threshold = float(os.getenv("GESTURE_SENSITIVITY_THRESHOLD"))
